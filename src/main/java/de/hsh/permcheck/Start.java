...
public class Start {
    ...
    private static void injectInternalClassesIntoBootClassLoader(TypePool typePool, String tempFolderForBootstrapInjection, String policy, Instrumentation instrumentation) throws IOException {
        ...
        String[] classNames = {
                ...
                "DenyReflectionGetClassLoaderCheck",
                "DenyReflectionGetClassLoaderCheck$DenyOnExit",
                "DenyReflectionGetClassLoaderCheck$DenyOnUnprivilegedMethodHandlesLookup",
                "DenyReflectionGetClassLoaderCheck$DenyOnMethodTypeFromMethodDescriptorString",
                "DenyReflectionGetClassLoaderCheck$DenySpecifiedLoaderIsNullAndCallerLoaderIsNotNull",
                "DenyReflectionGetClassLoaderCheck$DenyCallerModuleDifferentFromSpecifiedModule",
                "DenyReflectionCreateClassLoaderCheck",
                "DenyReflectionAccessClassInNonExportedBootLayerPackageCheck",
                "DenyReflectionAccessClassInNonExportedBootLayerPackageCheck$DenyFirstArgOnNonExportedBootLayerPackageInsert",
                "DenyReflectionAccessClassInNonExportedBootLayerPackageCheck$DenyOnMultiReturnAndOnTargetsLoaderIsNullAndCallerLoaderIsNotNullInsert",
                "DenyReflectionAccessClassInNonExportedBootLayerPackageCheck$DenyOnThisReturnAndOnTargetsLoaderIsNullAndCallerLoaderIsNotNullInsert",
				"DenyReflectionAccessClassInNonExportedBootLayerPackageCheck$DenyOnReturnedClassClassloaderIsNullAndCallerLoaderIsNotNullInsert",
                "DenyReflectionAccessClassInNonExportedBootLayerPackageCheck$DenyOnTargetClassloaderIsNullAndCallerLoaderIsNotNullInsert",
                "DenyReflectionAccessClassInNonExportedBootLayerPackageCheck$DenyLookupFirstArgOnNonExportedBootLayerPackageInsert",
                "DenyReflectionAccessClassInNonExportedBootLayerPackageCheck$DenyLookupFirstArgsClassOnNonExportedBootLayerPackageInsert",
                //"DenyReflectionAccessClassInNonExportedBootLayerPackageCheck$DenyResultClassArrayOnNonBootToBootClassLoaderAndNonExportedBootLayerPackageInsert",
                "DenyReflectionDefineClassCheck",
                "DenyReflectionDefineClassCheck$DenyOnMethodHandlesLessThanFullPrivilegesInsert",
                ...
                "DenyContextSetIOCheck",
                "DenyContextGetNetworkInformationCheck",
